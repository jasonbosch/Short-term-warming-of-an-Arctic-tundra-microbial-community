...
setwd("~/PostDoc/02_Projects/08_Disko_Island_Snow_Fence/04_Analysis_Results/Final")
...
#SVG
svg("Fig_1.svg", width=2*174*0.03937008, height=2*234*0.03937008)
Fig_X_Environmental_Variables
dev.off()
#JPG
jpeg("Fig_1.jpg", width=2*174, height=2*234, units = "mm", res = 300)
Fig_X_Environmental_Variables
dev.off()
...
Fig_X_Alpha_Beta_Diversity <- plot_grid(
  ...
  ncol = 1)
#SVG
svg("Fig_2.svg", width=2*174*0.03937008, height=2*120*0.03937008)
Fig_X_Alpha_Beta_Diversity
dev.off()
#JPG
jpeg("Fig_2.jpg", width=2*174, height=2*120, units = "mm", res = 300)
Fig_X_Alpha_Beta_Diversity
dev.off()
...
Presentation_DA <- ggplot(PresentationTable, aes(x = Order, y = log2FoldChange, fill = log2FoldChange>1)) +
  ...
  coord_flip()
#SVG
svg("Fig_4.svg", width=2*174*0.03937008, height=2*86*0.03937008)
Presentation_DA
dev.off()
#JPG
jpeg("Fig_4.jpg", width=2*174, height=2*86, units = "mm", res = 300)
Presentation_DA
dev.off()
...
Fig_X_RDA <- plot_grid(
  plot_grid(RDA_Figures[["bact_Total"]] + theme(legend.position = "none") + labs(tag = "A"),
                              ...
                              ncol = 1),
  RDA_legend, ncol = 1, rel_heights = c(1,0.05))
#SVG
svg("Fig_3.svg", width=2*84*0.03937008, height=2*234*0.03937008)
Fig_X_RDA
dev.off()
#JPG
jpeg("Fig_3.jpg", width=2*84, height=2*234, units = "mm", res = 300)
Fig_X_RDA
dev.off()
...
Fig_X_Guilds <- plot_grid(plot_guilds + labs(tag = "A"),
                          ...
                          ncol = 1)
#SVG
svg("Fig_5.svg", width=2*174*0.03937008, height=2*150*0.03937008)
Fig_X_Guilds
dev.off()
#JPG
jpeg("Fig_5.jpg", width=2*174, height=2*150, units = "mm", res = 300)
Fig_X_Guilds
dev.off()
...
# [1] metagMisc_0.5.0     ggpubfigs_0.0.1     mirlyn_1.4.2        phyloseq_1.52.0     ggnewscale_0.5.2    stringr_1.6.0       ggh4x_0.3.1        
# [8] MicrobiomeStat_1.2  lubridate_1.9.4     DescTools_0.99.60   multcompView_0.1-10 nlme_3.1-168        vegan_2.7-2         permute_0.9-8      
# [15] ggtext_0.1.2        ggrepel_0.9.6       ggsignif_0.6.4      ggpubr_0.6.2        ellipse_0.5.0       RColorBrewer_1.1-3  reshape2_1.4.4     
# [22] dplyr_1.1.4         cowplot_1.2.0       plyr_1.8.9          scales_1.4.0        ggplot2_4.0.0      
# 
# loaded via a namespace (and not attached):
# [1] rstudioapi_0.17.1       jsonlite_2.0.0          magrittr_2.0.4          farver_2.1.2            nloptr_2.2.1           
# [6] fs_1.6.6                vctrs_0.6.5             multtest_2.64.0         minqa_1.2.8             rstatix_0.7.3          
# [11] forcats_1.0.1           haven_2.5.5             broom_1.0.10            cellranger_1.1.0        Rhdf5lib_1.30.0        
# [16] Formula_1.2-5           rhdf5_2.52.0            rootSolve_1.8.2.4       igraph_2.2.1            lifecycle_1.0.4        
# [21] iterators_1.0.14        pkgconfig_2.0.3         Matrix_1.7-4            R6_2.6.1                GenomeInfoDbData_1.2.14
# [26] rbibutils_2.4           clue_0.3-66             digest_0.6.37           Exact_3.3               numDeriv_2016.8-1.1    
# [31] colorspace_2.1-2        spatial_7.3-18          S4Vectors_0.46.0        labeling_0.4.3          timechange_0.3.0       
# [36] httr_1.4.7              abind_1.4-8             mgcv_1.9-4              compiler_4.5.2          proxy_0.4-27           
# [41] withr_3.0.2             S7_0.2.0                backports_1.5.0         carData_3.0-5           MASS_7.3-65            
# [46] biomformat_1.36.0       fBasics_4041.97         gld_2.6.8               tools_4.5.2             ape_5.8-1              
# [51] glue_1.8.0              stabledist_0.7-2        rhdf5filters_1.20.0     gridtext_0.1.5          grid_4.5.2             
# [56] cluster_2.1.8.1         ade4_1.7-23             generics_0.1.4          gtable_0.3.6            tzdb_0.5.0             
# [61] class_7.3-23            tidyr_1.3.1             data.table_1.17.8       lmom_3.2                hms_1.1.4              
# [66] xml2_1.4.1              car_3.1-3               XVector_0.48.0          rmutil_1.1.10           BiocGenerics_0.54.1    
# [71] foreach_1.5.2           pillar_1.11.1           splines_4.5.2           lattice_0.22-7          survival_3.8-3         
# [76] tidyselect_1.2.1        Biostrings_2.76.0       reformulas_0.4.2        IRanges_2.42.0          stats4_4.5.2           
# [81] expm_1.0-0              Biobase_2.68.0          statmod_1.5.1           factoextra_1.0.7        timeDate_4051.111      
# [86] matrixStats_1.5.0       stringi_1.8.7           UCSC.utils_1.4.0        boot_1.3-32             codetools_0.2-20       
# [91] timeSeries_4041.111     tibble_3.3.0            cli_3.6.5               rpart_4.1.24            Rdpack_2.6.4           
# [96] Rcpp_1.1.0              GenomeInfoDb_1.44.3     readxl_1.4.5            stable_1.1.6            parallel_4.5.2         
# [101] modeest_2.4.0           readr_2.1.5             lme4_1.1-37             mvtnorm_1.3-3           lmerTest_3.1-3         
# [106] e1071_1.7-16            statip_0.2.3            purrr_1.2.0             crayon_1.5.3            rlang_1.1.6        